...
class Es101FollowerRobot(Robot):
    ...
    def __init__(self, config: Es101FollowerRobotConfig):
        ...
        self.bus = FeetechMotorsBus(
            ...
            motors={
                ...
                "wrist_yaw": Motor(6, "sts3215", MotorNormMode.DEGREES),
    ...
    def is_calibrated(self) -> bool:
        # call the func of bus.is_calibrated() to check (motor rom value == calibration file value)
    ...
    def send_action(self, action: RobotAction) -> RobotAction:
        ...
        """
        # cause action have cameras features
